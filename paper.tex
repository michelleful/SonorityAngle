...
\hline \end{tabular}} \renewcommand*\arraystretch{1} \end{center}
\vspace{0.5em}
     \d. Scenario 4: {\sc Son$\measuredangle$}(C\textsubscript{1}C\textsubscript{2}), {\sc Son$\measuredangle$}(C\textsubscript{2}C\textsubscript{3}) $>$ n \\
...
\ex. Scenario: {\sc Son$\measuredangle$}(C\textsubscript{2}C\textsubscript{3}) $>$ {\sc Son$\measuredangle$}(C\textsubscript{1}C\textsubscript{2}) $>$ n \\
