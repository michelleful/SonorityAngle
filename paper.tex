...
\noindent {\bf [C\textipa{1}CC] idiolect.} In the third idiolect \ref{C1CCidiolect} (c.f. Section 5.2 of of \citep{rose.2000}), most clusters epenthesise as [C\textipa{1}CC].
