...
\ex. Desiderata for a sonority contour similarity metric \label{desiderata}
...
I formalise the idea of faithfulness cost by defining a family of \textsc{Ident} constraints that penalise outputs that incur faithfulness costs of greater than a certain $n$, following \citep{flemming.2008}.
...
This family of faithfulness constraints forms a stringency hierarchy. Any cluster that would violate \textsc{Ident(SonAngle)}$<$n, would also violate {\sc Ident(SonAngle)}$<$m, where m$>$n.
