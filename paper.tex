...
a long vowel or diphthong (Green 1996), %TODO
...
\ex. \a. [\textipa{s\textsuperscript{j}e:mt}] \\
     ...
     (Words found in \citet{dinneen.2007}) %TODO

I conclude that in general, epenthesis does not occur in /NT/ sequences due to the large sonority angle between NT and NVT, and not to the non-existence of underlying heterorganic /NP/ clusters in the lexicon.
